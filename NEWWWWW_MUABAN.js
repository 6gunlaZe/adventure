...
const TRASH_ITEMS = [
  ...
  "lantern", "lostearring", "lspores", "maceofthedead", "merry", "mittens", "mittens1111","helmet1","helmet","shield",
...
const COMPOUND_RULES = [  
    ...
    { items: ["keepsakependant"], rules: [{ levels: [0,1], scroll: "cscroll1", offering: null },  ] },
...
// Need Strawberry, Honey & Blueberry Slices. Send me 1 nearby (≤400), I send 1 Mint Slice back. send_item("MuaBan",character.items.findIndex(i=>i&&i.name==="slice_honey"),1);
var TRADE = {
