...
supermittens: {bank: "items1", level: 3, quantity: 1},	
...
const muleItemsMap = {
    ...
    "Ynhi": ["elixirfires"],
	"haiz": ["tombkey111", "cryptkey","spiderkey"],
};
...
function taskBoss() {
    ...
    // === ⏱ Gọi bossvip3 tại phút 10 sau đăng nhập === ///đã xong nhiệm vụ đang tắt gọi boss
    const elapsed5 = Math.floor(elapsed / 10);
    if (elapsed5 > lastBossvip3Time && bossvip3Count < 1 && 1 > 2) {
...
var craftList = [ "x0","x1","x2","x3","x4","x5","x6","x7","x8","cshell","shield","gcape","sparkstaff","candy1","candy0","carrot","dexamulet","fallen","ink","cclaw","pmace","bowofthedead","pinkie","strring","dexearring","egg0","egg1","egg2","egg3","egg4","egg5","egg6","egg7","egg8","dexbelt","cryptkey","essenceofgreed","sshield","vdagger","vhammer","scythe","bataxe","rabbitsfoot","bfangamulet","suckerpunch","cdarktristone","powerglove","xarmor","tshirt9","fury","xhelmet","lostearring", "ololipop" , "supermittens" , "sweaterhs" , "xhelmet" , "xgloves" , "starkillers" , "wbookhs" , "crossbow" ,  "mcape" , "t2quiver" , "gem0" , "ornament" , "candycane" , "mistletoe" , "seashell"  ];
