...
async function eventer() {
    ...
    if (events) {
        ...
        { name: "frozen", count: count_item("frozenkey111"), action: framXmage, map: "winter_instance" }
...
setInterval(function() {
    ...
    let itemsToExclude = ["fieldgen0","frozenkey","spiderkey","candycanesword","elixirfires","hotchocolate","tombkey","elixirluck","candypop","hboots","cryptkey","hpot0", "mpot0","hpot1", "mpot1", "elixirint0","elixirstr0","elixirdex0","elixirint1","elixirstr1","elixirdex1", "luckbooster", "goldbooster", "xpbooster", "pumpkinspice", "xptome", "jacko","tracker","supermittens","mittens","xgloves","exoarm","hhelmet","fury","wbasher", "basher","bataxe","tigerstone","rabbitsfoot"];
