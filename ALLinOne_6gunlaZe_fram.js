...
const locations = {
  ...
  { type: "safe", x: 440, y: -999, map: "spookytown" }
    ...
    targetron: [
  { type: "farm", x: -435, y: -200, map: "uhills" }, 
...
if(( (leader && leader.hp < 10500 + mapHealBonus) || (healerr && healerr.hp < 8000 + mapHealBonus) || (fieldgen0 && (fieldgen0.hp / fieldgen0.max_hp) <= 0.7) || (f1112 && f1112.hp/f1112.max_hp < 0.4))  ){
...
function getPrioritizedTargets(targetNames, homeX, homeY, rangeThreshold, args = {}) {
    ...
    const alwaysIncludeMtypes = ["poisio","a5","crabx","nerfedmummy","bbpompom","booboo","wabbit","bee","cutebee","crab","grinch","squigtoad","osnake"];
...
// 3. bảo vệ party, chỉ áp dụng khi không phải trong solo
...
if (safePA !== safePB && SOLOMODE != 1 ) return safePA - safePB;
