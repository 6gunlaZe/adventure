...
{		
var targets1 = getBestTargets({ max_range: character.range, type: "quamanh", subtype: "frog11", number: 3 }); // Hàm gọi quái vật
...
setInterval(function() {
    ...
    let itemsToExclude = ["snowball","hpot0", "mpot0","hpot1", "mpot1", "elixirint0","elixirstr0","elixirdex0","elixirint1","elixirstr1","elixirdex1", "luckbooster", "goldbooster", "xpbooster", "pumpkinspice", "xptome","cscroll0", "cscroll1", "scroll0", "scroll1", "tracker","crossbow","jacko", "pouchbow","orbg"];
...
const avoidTypes = ["a0","a1","a2","a3","a4","a6", "a7","a8","a9","a10"];
