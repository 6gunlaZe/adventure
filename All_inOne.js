    ...
    try {
        ...
        if (character.ctype === "warrior") {
            try {
                ...
                if ( character.mp >= 170 && ( (f1 && f1.hp < f1.max_hp * 0.6 )  || (tank && tank.hp < tank.max_hp * 0.6 )  || (tank && tank.mp < 1000 && tank.ctype == "priest" ) || character.hp < 12000 ) && character.map != "winter_instance"  ){
