...
setInterval(function() {
    ...
    let itemsToExclude = ["elixirfires","hotchocolate","elixirluck","snowball","supermittens","handofmidas","hpot0", "mpot0","hpot1", "mpot1", "elixirint0","elixirstr0","elixirdex0","elixirint1","elixirint2","elixirstr1","elixirdex1", "luckbooster", "goldbooster", "xpbooster", "pumpkinspice", "xptome","cscroll0", "cscroll1", "scroll0", "scroll1", "tracker","harbringer","slimestaff","tigerstone","froststaff","wbook1"];
...
var target11= get_nearest_monster1({type: crepp, subtype: "bigbird" , NO_target: 1});
	...
	if (checkvar && cung1 ){
if (!target1 && character.targets <= 9 && target11 && character.mp > 2000 && character.hp/character.max_hp > 0.75 && cung1.hp > 12700 && cung1.mp > 200 && target11.level < 4 ) ////////////tùy chỉnh level theo độ mạnh của quái/////////////////hút quái cho framer
{
