...
function check_danger_nearby() {
    return Object.values(parent.entities).some(ent =>
        ...
        distance(character, ent) < (avoidingDanger ? 130 : 90)
    );
}
...
setInterval(function() {
    ...
    let itemsToExclude = ["elixirluck","snowball","wbookhs","mittens","handofmidas","hpot0", "mpot0","hpot1", "mpot1", "elixirint0","elixirstr0","elixirdex0","elixirint1","elixirint2","elixirstr1","elixirdex1", "luckbooster", "goldbooster", "xpbooster", "pumpkinspice", "xptome","cscroll0", "cscroll1", "scroll0", "scroll1", "tracker","harbringer","jacko","slimestaff","tigerstone","froststaff","wbook1"];
