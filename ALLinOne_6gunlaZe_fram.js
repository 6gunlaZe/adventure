...
const equipmentSets = {
   ...
   //	{ itemName: "t2quiver", slot: "offhand", level: 8, l: "l" },
    ...
    boom: [
       ...
       // { itemName: "firebow", slot: "mainhand", level: 10, l: "l" },
        { itemName: "pouchbow", slot: "mainhand", level: 10, l: "l" },
...
setInterval(function() {
    ...
    let itemsToExclude = ["poison","pants","coat","pumpkinspice","mittens","supermittens","snowball","hpot0", "mpot0","hpot1", "mpot1", "elixirint0","elixirstr0","elixirdex0","elixirint1","elixirstr1","elixirdex1", "luckbooster", "goldbooster", "xpbooster", "pumpkinspice", "xptome","cscroll0", "cscroll1", "scroll0", "scroll1", "tracker","crossbow","jacko", "pouchbow","orbg","cupid"];
